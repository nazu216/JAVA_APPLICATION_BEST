    ...
    stages{
        ...
        stage ('Uploading to Ecr') {
            steps {
                ...
                sh 'docker tag javaimage:latest 526174677628.dkr.ecr.ap-northeast-1.amazonaws.com/ripecr:1.0.nazeefa'
                sh 'docker push 526174677628.dkr.ecr.ap-northeast-1.amazonaws.com/ripecr:1.0.nazeefa'
            }
        }
